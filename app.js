...
function renderTodaySummary(){
  ...
  $('todaySummary').innerHTML=`<div class="today-date"><span>OGGI</span>${entry.variationFrom?`<em class="variation-badge" title="${escapeHtml(entry.variationFrom)} → ${escapeHtml(entry.variationTo||entry.shift)}">VAR.</em>`:''}${entry.manualModified?'<em class="manual-badge" title="Giornata modificata manualmente">MOD.</em>':''}<strong>${dateLabel}</strong></div><div class="today-inline-form">
