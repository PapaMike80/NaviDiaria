...
function renderTodaySummary(){
  ...
  $('todaySummary').innerHTML=`<div class="today-date"><span>OGGI</span><strong>${dateLabel}</strong></div><div class="today-inline-form">
