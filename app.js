...
function renderTodaySummary(){
  ...
  $('todaySummary').innerHTML=`<div class="today-date"><span>OGGI</span><strong>${dateLabel}</strong>${entry.variationFrom?`<em class="variation-badge">VARIAZIONE ${escapeHtml(entry.variationFrom)} → ${escapeHtml(entry.variationTo||entry.shift)}</em>`:''}</div><div class="today-inline-form">
