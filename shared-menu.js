(function(){
  ...
  if(page==='diaria'){
    common=item('naviturni.html','▦','NaviTurni',false,true)+item('#oggi','≈','NaviDiaria',true,false,'diariaNavLink')+item('turni.html','▤','ODS / Turni',false,true,'archiveNavLink');
    ...
    common=item('#turni-operativi','▦','NaviTurni',true)+item('navidiaria.html','≈','NaviDiaria',false,true,'diariaNavLink')+item('turni.html','▤','ODS / Turni',false,true,'archiveNavLink');
    ...
    common=item('naviturni.html','▦','NaviTurni',false,true)+item('navidiaria.html','≈','NaviDiaria',false,true,'diariaNavLink')+item('#turni-docs','▤','ODS / Turni',true,false,'archiveNavLink');
