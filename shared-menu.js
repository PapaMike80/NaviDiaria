(function(){
  ...
  if(page==='diaria'){
    ...
    common=item('#turni-operativi','▦','NaviTurni',true)+item('navidiaria.html','≈','NaviDiaria',false,true,'diariaNavLink')+item('documenti.html','▤','Documenti',false,true,'archiveNavLink');
